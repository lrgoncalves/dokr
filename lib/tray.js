...
module.exports = class TrayMenu {
  ...
  async renderContainers() {
    ...
    return containers.map((container, index) => {
      ...
      if (typeof container.data.Names != undefined && typeof container.data.Names[0] != undefined) {
        var containerLabel = container.data.Names[0];
      } else {
        var containerLabel = container.data.Image;
      }
